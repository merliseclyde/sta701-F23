...
```{r, echo=FALSE, message=FALSE, results='hide'}
make_link = function(title, abs) {
    ifelse(is.na(abs), 
        NA, 
        paste0("<a href=\"", "abstracts/", abs, "\">",
                title,"</a>"))
}

schedule.Fall$Title = make_link(schedule.Fall$Title, schedule.Fall$abstract)
```
